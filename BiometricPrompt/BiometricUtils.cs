...
namespace BiometricPrompt
{
    public class BiometricUtils
    {
        ...
        {
            return (Build.VERSION.SdkInt >= Android.OS.BuildVersionCodes.M);
        }
        ...
        {
            return Android.Support.V4.Content.ContextCompat.CheckSelfPermission(context, Manifest.Permission.UseFingerprint) == Android.Content.PM.Permission.Granted;
        }
    }
}
